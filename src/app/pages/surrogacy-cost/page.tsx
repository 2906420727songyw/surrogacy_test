...
const SurrogacyCost: React.FC = () => {
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <h2 className="text-white text-xl mb-20 text-center md:text-4xl">
        信托公司：付款流程和资金保障
      </h2>
      <p className="text-white text-sm mb-20 text-center md:text-lg">
      ...
      <p className="text-white text-sm text-center md:text-base">
    ...
    <div className={styles.packageContainer}>
      ...
      <p className="text-white text-sm mb-20 text-center px-5 md:text-lg md:mt-20">

  ...
  return (
    <div id="parents-overview" className={styles.content}>
      <div className={styles.container}>
        <h1 className="text-3xl mb-10 md:mb-20 md:text-6xl">
          Sapling Surrogacy
        </h1>
        <p className="text-sm leading-6 mb-10 md:text-xl md:leading-10 md:mb-11">
          欢迎来到Sapling辅助生殖代孕中心。<br/>
          帮助您一起建立幸福而美满的家庭是我们最大的愿望。<br/>
          代孕是一条漫长、充满挑战而又伟大的道路,若您感到迷茫和无助,<br/>
          请不要担心,Sapling将在这里全程陪伴您为您答疑解惑并提供最大的助力。<br/>
          我们坚信,所有的努力都是值得的。有Sapling在旁,您的代孕之旅将会格外安心且愉悦。<br/>
        </p>
        
        <button className="w-14 h-6 md:w-20 md:h-8 rounded text-xs md:text-sm font-medium text-black bg-[#cdc6c0] hover:bg-gray-100 transition duration-200 mb-10 md:mb-20">
          开始咨询
        </button>
      </div>
      ...
      layout="responsive"
      />
      <div className="w-full flex flex-col items-center text-center text-white px-5 md:w-full">
        <h2 className="text-3xl my-10 md:text-5xl md:my-24">
          <p>为什么准父母会选择</p>
          <p>Sapling Surrogacy</p>
        </h2>
        <div className="text-sm mb-10 leading-8 md:text-lg md:mb-14 md:leading-10">
        ...
        <div className="text-sm leading-8 md:text-lg md:leading-10">

    ...
    <div className={styles.part4}>
      ...
      <div id="egg-sperm-donation-help" className={styles.content}>
        <div className="w-full flex flex-col items-center justify-center px-5">
          ...
          <p className="text-sm leading-6 text-white text-center mb-12 md:text-base md:leading-10 md:mb-14">
          ...
          <div className={styles.transparentContent}>
            ...
            <div className={styles.itemsContainer}>
              <div className={styles.item}>
                ...
                layout="responsive"
                />
                <p className="text-xs leading-5 text-white text-center md:text-sm md:leading-6 md:text-left">
              ...
              <div className={styles.item}>
                ...
                layout="responsive"
                />
                <p className="text-xs leading-5 text-white text-center mb-10 md:text-sm md:leading-6 md:text-left">
          ...
          <div className={styles.transparentContent}>
            ...
            <div className={styles.itemsContainer}>
              <div className={styles.item}>
                ...
                layout="responsive"
                />
                <p className="text-xs leading-5 text-white text-center md:text-sm md:leading-6 md:mb-14 md:text-left">

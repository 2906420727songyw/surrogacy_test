    ...
    <div id="surrogacy-plan-process" className={styles.part3}>
      ...
      <div className={styles.content}>
        <div className="w-full flex flex-col items-center justify-center px-5">
          ...
          <p className="text-sm leading-6 text-white text-center mb-10 md:text-xl md:leading-10 md:mb-0">
            代孕的旅程中包含许多的节点和步骤，而每对准父母会因为其自身的情况、需求以及喜好,有着不同的时间线和旅程。
          </p>
          <p className="text-sm leading-6 text-white text-center mb-10 md:text-xl md:leading-10 md:mb-11">
            通常来说，在经历12-24个月之后，您就可以带着您的宝宝回家，在此期间，Sapling会有专业的团队一对一陪伴您走过整个旅程。
          </p>
          <p className="text-sm leading-6 text-white text-center mb-10 md:text-xl md:leading-10 md:mb-0">为了让您更好的了解代孕需要做什么，每个阶段的结果是什么，以及大致的时间线。</p>
          <p className="text-sm leading-6 text-white text-center mb-10 md:text-xl md:leading-10 md:mb-11">在这里，我们大致将代孕旅程分为了五个阶段供您参考</p>
        ...
        <div className={styles.divider}></div>
            <p className="text-xl text-white mb-4 mt-6 md:text-3xl md:mb-4 md:mt-8">
              {isStep1Clicked ? '第一步' : '第一步'}
            </p>
            <p className="text-base text-white mb-6 md:text-xl md:mb-8">
              {isStep1Clicked ? '咨询和签约(0-1个月)' : '咨询和签约(0-1个月)'}
            </p>
            {isStep1Clicked && (
              <div>
                <p className="text-sm text-white leading-6 mb-6 mt-8 md:text-lg md:mb-8 md:mt-16 md:leading-10">

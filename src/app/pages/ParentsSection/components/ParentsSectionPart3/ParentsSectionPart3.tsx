      ...
      <div id="surrogacy-plan-process" className={styles.content}>
        ...
        <div className={styles.divider}></div>
            <p className="text-sm text-white mb-4 mt-6 md:text-xl md:mb-4 md:mt-8">
              {step1Ref.current ? '第一步' : '第一步'}
            </p>
            <p className="text-sm text-white mb-6 md:text-base md:mb-8">
              {step1Ref.current ? '咨询和签约（0-1个月）' : '咨询和签约（0-1个月）'}
            </p>
            <div className={styles.details}>
              <p className="text-xs text-white leading-5 mb-6 mt-8 md:text-sm md:mb-8 md:mt-16 md:leading-6">
          ...
          >
            <p className="text-sm text-white mb-4 mt-6 md:text-base md:mb-4 md:mt-8">
              {step2Ref.current ? '第二步' : '第二步'}
            </p>
            <p className="text-sm text-white mb-6 md:text-base md:mb-8">
              {step2Ref.current ? '代孕妈妈的双向选择（时间各不相同）' : '代孕妈妈的双向选择（时间各不相同）'}
            </p>
            <div className={styles.details}>
              <p className="text-xs text-white leading-5 mb-6 mt-8 md:text-sm md:mb-8 md:mt-16 md:leading-6">
          ...
          >
            <p className="text-sm text-white mb-4 mt-6 md:text-base md:mb-4 md:mt-8">
              {step3Ref.current ? '第三步' : '第三步'}
            </p>
            <p className="text-sm text-white mb-6 md:text-base md:mb-8">
              {step3Ref.current ? '试管庆院和法律文件（3-4个月）' : '试管庆院和法律文件（3-4个月）'}
            </p>
            <div className={styles.details}>
              <p className="text-xs text-white leading-5 mb-6 mt-8 md:text-sm md:mb-8 md:mt-16 md:leading-6">
          ...
          >
            <p className="text-sm text-white mb-4 mt-6 md:text-base md:mb-4 md:mt-8">
              {step4Ref.current ? '第四步' : '第四步'}
            </p>
            <p className="text-sm text-white mb-6 md:text-base md:mb-8">
              {step4Ref.current ? '代孕妈妈怀孕（8-9个月）' : '代孕妈妈怀孕（8-9个月）'}
            </p>
            <div className={styles.details}>
              <p className="text-xs text-white leading-5 mb-6 mt-8 md:text-sm md:mb-8 md:mt-16 md:leading-6">
          ...
          >
            <p className="text-sm text-white mb-4 mt-6 md:text-base md:mb-4 md:mt-8">
              {step5Ref.current ? '第五步' : '第五步'}
            </p>
            <p className="text-sm text-white mb-6 md:text-base md:mb-8">
              {step5Ref.current ? '迎接宝宝的出生' : '迎接宝宝的出生'}
            </p>
            <div className={styles.details}>
              <p className="text-xs text-white leading-5 mb-6 mt-8 md:text-sm md:mb-8 md:mt-16 md:leading-6">

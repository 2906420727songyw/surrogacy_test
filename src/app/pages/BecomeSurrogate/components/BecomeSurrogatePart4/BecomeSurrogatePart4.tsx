    ...
    <div className={styles.becomeSurrogatePart4}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <h2 className={styles.title}>Sapling给到代孕妈妈的薪酬和补偿将分为三个方面：</h2>
        </div>
        <div className={styles.itemContainer}>
          <div className={styles.item}>
            <div className={styles.divider}></div>
            <p className={styles.itemTitle}>基本薪资</p>
          ...
          <div className={styles.item}>
            <div className={styles.divider}></div>
            <p className={styles.itemTitle}>基本补偿</p>
            <p className={styles.itemDetails}>
          ...
          <div className={styles.item}>
            <div className={styles.divider}></div>
            <p className={styles.itemTitle}>额外福利</p>
            <p className={styles.itemDetails}>
        ...
        <div className={styles.content}>
          <h2 className={styles.title}>代孕妈妈收到的薪酬和补偿的时间：</h2>
        </div>
        <div className={styles.itemContainer}>
          <div className={styles.item}>
            <div className={styles.divider}></div>
          ...
          <p className={styles.additionalText}>
            如果您怀的是多胞胎,我们会在您代孕的最后五个月向您支付多胞胎费用。<br/>
            单胞胎代孕 34 周后,多胞胎代孕 32 周后,您的代孕怀孕才算可行。<br/>
            如果您在 40 周前分娩,我们会一次性支付剩余费用。<br/>
            其余杂费将在整个怀孕期间分期支付,并将在您的筛查中讨论。
          </p>
          <button className={styles.button}>立即申请</button>
        </div>
      </div>

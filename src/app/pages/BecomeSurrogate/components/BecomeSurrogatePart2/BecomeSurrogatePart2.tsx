...
export default function BecomeSurrogatePart2({ isVisible = false }: BecomeSurrogatePart2Props) {
        ...
        <div className={styles.itemContainer}>
          <div className={styles.item}>
            ...
            <p className="h2-text text-white mb-4 mt-6 md:text-base md:mt-8 md:mb-6">
              A.身体健康评估</p>
            <p className="h3-text text-white text-center mb-6 md:text-sm md:mb-8">

      ...
      <div className={styles.hero}>
        <div className="w-full">
          <h1 
            ...
            className={`h1-text text-white mb-10 md:text-4xl md:mb-20 ${visibleElements.has('main-title') ? 'animate__animated animate__fadeInDown animate__duration-1s animate__delay-1s' : ''}`}
          >
            关于我们
          </h1>

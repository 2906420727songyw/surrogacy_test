  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center bg-[#A48472] py-20">
      ...
      <div className="w-full max-w-[70vw] pt-[calc(env(safe-area-inset-top)+4rem)] md:pt-[15vh]">
        <h1 className="text-white text-[32px] md:text-[48px] font-normal text-center mb-[20px] md:mb-[80px] transition-opacity duration-500 animate__animated animate__fadeInDown animate__duration-1s animate__delay-1s">
          使用电子邮件地址创建账户
        </h1>

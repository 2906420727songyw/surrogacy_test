  ...
  return (
    <section className={styles.aboutUs}>
      ...
      <div className="mx-auto flex flex-col items-center w-full h-auto md:w-full px-5 md:px-[150px]">
       ...
       <p className={` text-white mb-1.5  md:mb-3 en-width ${translations.language==='EN'?'h2-text':'h2-text-en'}`} dangerouslySetInnerHTML={{ __html: translations.about_us_title.desc }}>
       </p>
       </div>
      </div>

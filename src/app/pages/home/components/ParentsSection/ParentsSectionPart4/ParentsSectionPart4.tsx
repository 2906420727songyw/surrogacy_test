      ...
      <div className={styles.content}>
        ...
        <div className={styles.transparentContainer}>
          ...
          <div className={styles.transparentContent}>
            ...
            <div className={styles.itemsContainer}>
              <div className={styles.item}>
                <img src="/images/home/icon1.png" alt="第一个div的图片" className={styles.itemImage} />
              ...
              <div className={styles.item}>
                <img src="/images/home/icon2.png" alt="第二个div的图片" className={styles.itemImage} />
                <p className={styles.itemText}>
          ...
          <div className={styles.transparentContent}>
            ...
            <div className={styles.itemsContainer}>
              <div className={styles.item}>
                <img src="/images/home/icon3.png" alt="第一个div的图片" className={styles.itemImage} />
                <p className={styles.itemText}>
                1.当您注册成功后，会有与我们合作的卵子精子库的工作人员加入，他们会为您提供捐赠者名单，让您选择心仅的捐赠者。
                </p>
              </div>
              <div className={styles.item}>
                <img src="/images/home/icon4.png" alt="第二个div的图片" className={styles.itemImage} />
                <p className={styles.itemText}>

  ...
  return (
    <section className={styles.dataDisplay}>
      <div className={styles.content}>
       ...
       <p className={`${translations.language==='EN'?'h2-text':'h2-text-en en-width'} mb-2.5 text-white en-width`}  dangerouslySetInnerHTML={{ __html: translations.home.DataDisplay.desc }}>

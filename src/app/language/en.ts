...
register:{
    title:'Create an account with your email address',
    emial:'Sign up with your email address',
    ...
    country:'Country',
    postalCode:'ZIP Code',
    agreement:"By checking this box, you agree to receive updates about our programs in line with our Privacy Policy. Sapling Surrogacy may send you the latest information via email, mail, or text message.",
    register:'Register',
    loading:'Registering...',   
},
surrogateApplication:{
    title:'Surrogate Application Form',
    name:'Full Name *',
    age:'Age *',
    ...
    addressInformation:'Address Details',
    address:'Street Address *',
    city:'City & State *',
    code:'ZIP Code *',
    phone:'Phone Number *',
...
agreementDetails:{
  haveAgreement:"Your in-person consultation is confirmed!",
  agreementDetail:"Appointment Details",
  noAgreement:"No Appointment Yet",
  noAgreementContent:"You haven’t booked a consultation.",
  agreementNow:"Tap the button below to schedule now.",
  agreementBtn:"Book Now",
  restart:"Reschedule Appointment",
  return:"Back"
}
}
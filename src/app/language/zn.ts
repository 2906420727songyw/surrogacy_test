export default {
    ...
    about_us:[
      ...
      about_us_title:{
        title1:'小树苗代孕中心',
        title2:'关于我们',
        desc:'小树苗代孕中心以卓越的成功率和贴心的专业支持，陪伴每一位客户踏上实现家庭梦想的旅程。</br>我们始终秉持责任与关怀，用行业领先的全方位服务，为客户提供安心的保障和温暖的陪伴，让每一步都充满信任与希望。',
        more:'了解更多'
      },
      home:{
        BecomingParents:{
    ...
    becomeSurrogate:{
        ...
        becomeSurrogatePart4:{
            ...
            why:{
                ...
                content:[
                    '小树苗致力于为每一位代孕妈妈提供全程支持与贴心陪伴。',
                    '代孕是一段既耗费精力又充满情感与体力挑战的旅程，',
                    '为此，小树苗设立了专业的团队和部门，',
                    '全程与代孕妈妈保持紧密联系，提供全方位的关怀与帮助。',
                ],
            ...
            how:{
                title: "代孕妈妈的薪酬和补偿",
                content:["根据所在州的政策及代孕经历的不同，每位代孕妈妈的薪酬和补偿会有所差异。","我们承诺，为小树苗的代孕妈妈提供行业内顶尖的薪酬，以及尽可能全面的补偿方案，以保障每","一位代孕妈妈的付出都能得到应有的回报。"],
